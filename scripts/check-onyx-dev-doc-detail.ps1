...
$repo = "onyx-dev-doc-deck"
$language = "Rust"
$category = "Developer tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/onyx-dev-doc-walkthrough.md")) {
